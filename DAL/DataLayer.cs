...
namespace DAL
{
    public class DataLayer
    {
        ...
        public DataLayer()
        {
            sqlConnection = new SqlConnection(@"Data Source=HOSAM\MSSQLSERVER02;Initial Catalog=Yousef Pharmacy96;TrustServerCertificate=True;Integrated Security=True");
